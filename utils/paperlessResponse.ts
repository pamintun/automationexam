import { faker } from '@faker-js/faker';
  ...
  /**
   * Generate new datablob, using dynamic values, and created new test link.
   * @returns [0] TestURL [1] Dynamic Data 
   */
  export default function generateEncodedDataLink(){
    const studioId = faker.string.uuid(); 
    const dynamicData = {
        ...
        member_phone_number: faker.phone.number(),
        studio_id: studioId,
